...
@Component({
  ...
  templateUrl: './activity-list-meet.component.html',
  styleUrls: ['./activity-list-meet.component.scss']
})
export class ActivityListMeetComponent implements OnInit {
  //data for component table
  listTbData = {
    clickDetail: CLICK_DETAIL.ACTIVITY,
    listColum: [
      { name: 'Khách hàng', cell: 'contactName' },
      { name: 'Công ty', cell: 'companyName' },
      { name: 'Mô tả', cell: 'description' },
      { name: 'Thời gian gặp', cell: 'duration' },
