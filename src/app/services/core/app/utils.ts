export class Utils {
    ...
    public static getTimeDistance(date: Date): string {
      ...
      if (hour == 0 && minutes == 0 && second == 0) {
        return "Vừa xong";
      }else if (hour == 0 && minutes == 0 && second > 0) {
    ...
    public static getStringShowMap(name): string {
      return "https://www.google.com/maps/search/" + name;
    }
  
    public static sortArrayByAtribute(array: Array<any>, att, type) {
      if (type == 'desc') {
        array.sort((a, b) => {
          return b.att - a.att;
        })
    ...
    public static ignorecase(text: string) : string{
