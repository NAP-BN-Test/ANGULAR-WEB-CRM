...
export class ApiService extends HttpClient {
  ...
  ip = localStorage.getItem(LOCAL_STORAGE_KEY.SERVER_INFO)
    ? JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEY.SERVER_INFO)).ip
    : "";
  dbName = localStorage.getItem(LOCAL_STORAGE_KEY.SERVER_INFO)
    ? JSON.parse(localStorage.getItem(LOCAL_STORAGE_KEY.SERVER_INFO)).dbName
    : "";
  ...
  public sendRequestGET_LIST_QUICK_CONTACT(companyID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_QUICK_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_COMPANY(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_DETAIL_COMPANY(companyID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_DETAIL_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_QUICK_COMPANY(companyID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_QUICK_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_QUICK_DEAL(companyID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_QUICK_DEAL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //7
  public sendRequestGET_LIST_ACTIVITY(
    companyID: string,
    activityType: number,
    activityID?: number,
    attendID?: number
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_ACTIVITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_CONTACT(companyID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_CONTACT_FULL(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_CONTACT_FULL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestUPDATE_ACTIVITY(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_ACTIVITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_MEET_ATTEND(meetID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_MEET_ATTEND,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_USER(all?: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_USER,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_NOTE_ASSOCIATE(noteID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_NOTE_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //15
  public sendRequestUPDATE_NOTE_ASSOCIATE(
    contactID: number,
    noteID: number,
    state: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_NOTE_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //18
  public sendRequestADD_COMMENT(
    userName: string,
    activity: any,
    content: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_COMMENT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //19
  public sendRequestEDIT_COMMENT(
    activity: any,
    cmtID: number,
    content: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.EDIT_COMMENT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_COMMENT(activity: any, cmtID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_COMMENT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //22
  public sendRequestUPDATE_MEET_ATTEND(
    meetID: number,
    listUserID: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_MEET_ATTEND,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //26
  public sendRequestADD_CONTACT_BY_ID(
    companyID: string,
    contactID: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CONTACT_BY_ID,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestSEARCH_CONTACT(searchKey: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.SEARCH_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestUPDATE_COMPANY(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_CALL_ASSOCIATE(callID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CALL_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //30
  public sendRequestUPDATE_CALL_ASSOCIATE(
    contactID: number,
    callID: number,
    state: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_CALL_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_EMAIL_ASSOCIATE(emailID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_EMAIL_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //32
  public sendRequestUPDATE_EMAIL_ASSOCIATE(
    contactID: number,
    emailID: number,
    state: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_EMAIL_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_MEET_ASSOCIATE(meetID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_MEET_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //34
  public sendRequestUPDATE_MEET_ASSOCIATE(
    contactID: number,
    meetID: number,
    state: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_MEET_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_TASK_ASSOCIATE(taskID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_TASK_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //36
  public sendRequestUPDATE_TASK_ASSOCIATE(
    contactID: number,
    taskID: number,
    state: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_TASK_ASSOCIATE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //37
  public sendRequestSEARCH_COMPANY(
    companyID: string,
    searchKey: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.SEARCH_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //39
  public sendRequestADD_PARENT_COMPANY_BY_ID(
    companyID: string,
    companyAddID: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_PARENT_COMPANY_BY_ID,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //40
  public sendRequestADD_CHILD_COMPANY_BY_ID(
    companyID: string,
    companyAddID: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CHILD_COMPANY_BY_ID,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_DEAL_STAGE(): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_DEAL_STAGE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_DETAIL_CONTACT(contactID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_DETAIL_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //43
  public sendRequestGET_LIST_ACTIVITY_FOR_CONTACT(
    contactID: string,
    activityType: number,
    activityID?: number,
    attendID?: number
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_ACTIVITY_FOR_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //44
  public sendRequestGET_LIST_QUICK_DEAL_FOR_CONTACT(
    contactID: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_QUICK_DEAL_FOR_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //45
  public sendRequestUPDATE_CONTACT(
    contactID: string,
    contactName?: string,
    contactAddress?: string,
    contactPhone?: string,
    contactEmail?: string,
    contactJobTile?: string
  ): Promise<any> {
    return this.requestPost(
  ...
  //46
  public sendRequestASSIGN_COMPANY_OWNER(
    assignID: number,
    companyIDs: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ASSIGN_COMPANY_OWNER,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //47
  public sendRequestASSIGN_CONTACT_OWNER(
    assignID: number,
    contactIDs: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ASSIGN_CONTACT_OWNER,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CONTACT(contactIDs: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //48
  public sendRequestFOLLOW_COMPANY(
    companyID: string,
    follow: boolean
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.FOLLOW_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //49
  public sendRequestFOLLOW_CONTACT(
    contactID: string,
    follow: boolean
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.FOLLOW_CONTACT,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_COMPANY(companyIDs: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_TASK(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_TASK,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //52
  public sendRequestUPDATE_TASK(
    taskIDs: string,
    status: boolean
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_TASK,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CONTACT_FROM_COMPANY(contactID): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CONTACT_FROM_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //54
  public sendRequestDELETE_COMPANY_FROM_COMPANY(
    role: number,
    companyID: string,
    companyIDRemove: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_COMPANY_FROM_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_DEAL_FROM_COMPANY(dealID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_DEAL_FROM_COMPANY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_CALL(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_CALL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_EMAIL(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_EMAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_MEET(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_MEET,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_NOTE(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_NOTE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_SUMMARY_INFO(): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_SUMMARY_INFO,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_CITY(): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_CITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_CATEGORY_LIST_USER(searchKey: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_LIST_USER,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_MAIL_LIST(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_MAIL_LIST,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_MAIL_LIST_DETAIL(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_MAIL_LIST_DETAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_REPORT_BY_CAMPAIN(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_REPORT_BY_CAMPAIN,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_LIST_REPORT_BY_MAILLIST(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_LIST_REPORT_BY_MAILLIST,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_REPORT_BY_CAMPAIN_SUMMARY(
    campainID: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_REPORT_BY_CAMPAIN_SUMMARY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_REPORT_BY_MAILLIST_SUMMARY(
    mailListID: number
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_REPORT_BY_MAILLIST_SUMMARY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_REPORT_BY_CAMPAIN_MAIL_TYPE(
    campainID: number,
    mailType,
    timeType: number,
    timeFrom?: string,
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_REPORT_BY_CAMPAIN_MAIL_TYPE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_REPORT_BY_MAILLIST_TYPE(
    mailListID: number,
    mailType,
    timeType: number,
    timeFrom?: string,
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_REPORT_BY_MAILLIST_TYPE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_REPORT_BY_USER_SUMMARY(): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_REPORT_BY_USER_SUMMARY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_REPORT_BY_USER_MAIL_TYPE(
    mailType,
    timeType: number,
    timeFrom?: string,
    timeTo?: string
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_REPORT_BY_USER_MAIL_TYPE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_MAIL_LIST_OPTION(): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_MAIL_LIST_OPTION,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_MAIL_CAMPAIN(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_MAIL_CAMPAIN,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_MAIL_LIST_DETAIL(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_MAIL_LIST_DETAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestADD_MAIL_LIST_DETAIL(
    mailListID: number,
    listMail: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_MAIL_LIST_DETAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_MAIL_CAMPAIN(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_MAIL_CAMPAIN,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_MAIL_CAMPAIN_DETAIL(campainID: number): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_MAIL_CAMPAIN_DETAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestADD_MAIL_SEND(
    obj: any,
    isTestMail?: boolean
  ): Promise<any> {
    let body = obj.body.replace(/&/g, "%26");
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_MAIL_SEND,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestCHECK_VERIFY_EMAIL(email: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.CHECK_VERIFY_EMAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestREPORT_MAIL_DETAIL(
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.REPORT_MAIL_DETAIL,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_CATEGORY_CITY(
    page: number,
    searchKey: string
  ): Promise<any> {
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_CITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_CATEGORY_CITY(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CATEGORY_CITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestUPDATE_CATEGORY_CITY(obj: any, cityID): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_CATEGORY_CITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CATEGORY_CITY(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CATEGORY_CITY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_ALL_CATEGORY_COUNTRY(): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_ALL_CATEGORY_COUNTRY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_CATEGORY_COUNTRY(
    page: number,
    searchKey: string
  ): Promise<any> {
    let mSearchKey = searchKey != "" ? searchKey : null;
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_COUNTRY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_CATEGORY_COUNTRY(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CATEGORY_COUNTRY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CATEGORY_COUNTRY(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CATEGORY_COUNTRY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestGET_CATEGORY_STEP(
    page: number,
    searchKey: string
  ): Promise<any> {
    let mSearchKey = searchKey != "" ? searchKey : null;
    ...
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_STEP,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_CATEGORY_STEP(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CATEGORY_STEP,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestUPDATE_CATEGORY_STEP(obj: any, stepID): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_CATEGORY_STEP,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CATEGORY_STEP(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CATEGORY_STEP,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestADD_HISTORY(
    name: string,
    router: string,
    param: string
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_HISTORY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_HISTORY(historyID): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_HISTORY,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_CATEGORY_JOB_TILE(searchKey: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_JOB_TILE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_CATEGORY_JOB_TILE(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CATEGORY_JOB_TILE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestUPDATE_CATEGORY_JOB_TILE(
    obj: any,
    categoryID
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_CATEGORY_JOB_TILE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CATEGORY_JOB_TILE(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CATEGORY_JOB_TILE,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_CATEGORY_MAIL_OUTCOME(searchKey: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_MAIL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_CATEGORY_MAIL_OUTCOME(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CATEGORY_MAIL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestUPDATE_CATEGORY_MAIL_OUTCOME(
    obj: any,
    categoryID
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_CATEGORY_MAIL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CATEGORY_MAIL_OUTCOME(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CATEGORY_MAIL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestGET_CATEGORY_CALL_OUTCOME(searchKey: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.GET_CATEGORY_CALL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestADD_CATEGORY_CALL_OUTCOME(obj: any): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.ADD_CATEGORY_CALL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  //==============================
  public sendRequestUPDATE_CATEGORY_CALL_OUTCOME(
    obj: any,
    categoryID
  ): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.UPDATE_CATEGORY_CALL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestDELETE_CATEGORY_CALL_OUTCOME(listID: string): Promise<any> {
    return this.requestPost(
      this.mUrl + ApiCmd.DELETE_CATEGORY_CALL_OUTCOME,
      ParamBuilder.builder()
        .add("ip", this.ip)
        .add("dbName", this.dbName)
        .add("secretKey", this.mSecretKey)
  ...
  public sendRequestUPDATE_ADDITIONAL_INFORMATION(obj: any): Promise<any> {
    return this.requestPost(
      ...
      ParamBuilder.builder()
        ...
        .addIgnoreNull("Owner", obj.Owner)
        .addIgnoreNull("RegNo", obj.RegNo)
