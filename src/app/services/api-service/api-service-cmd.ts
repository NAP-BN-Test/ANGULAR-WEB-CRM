export class ApiCmd {
    ...
    public static GET_LIST_COMPANY: string = "crm/get_list_company";

    public static GET_DETAIL_COMPANY: string = "crm/get_detail_company";

    public static GET_LIST_QUICK_COMPANY: string = "crm/get_list_quick_company";

    public static GET_LIST_QUICK_DEAL: string = "crm/get_list_quick_deal";

    public static GET_LIST_QUICK_DEAL_FOR_CONTACT: string = "crm/get_list_quick_deal_for_contact";
    ...
    public static GET_DETAIL_CONTACT: string = "crm/get_detail_contact";

    public static GET_LIST_ACTIVITY_FOR_CONTACT: string = "crm/get_list_activity_for_contact";
    ...
    public static GET_MAIL_LIST_OPTION: string = "crm/get_mail_list_option";

    public static ADD_MAIL_CAMPAIN: string = "crm/add_mail_campain";

    public static ADD_MAIL_LIST: string = "crm/add_mail_list";

    public static DELETE_MAIL_LIST: string = "crm/delete_mail_list";

    public static DELETE_MAIL_LIST_DETAIL: string = "crm/delete_mail_list_detail";
