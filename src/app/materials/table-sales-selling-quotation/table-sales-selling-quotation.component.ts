...
import { BUTTON_TYPE, EVENT_PUSH } from 'src/app/services/constant/app-constant';

@Component({
  selector: "app-table-sales-selling-quotation",
  templateUrl: "./table-sales-selling-quotation.component.html",
  styleUrls: ["./table-sales-selling-quotation.component.scss"],
})
export class TableSalesSellingQuotationComponent implements OnInit {
